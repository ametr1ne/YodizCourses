...
<main class="main">
				...
				<div class="course">
					<div class="course__header">
						...
						<div>
							...
							<p class="students text-grey">73 — ученика проходит курс</p>
						</div>
					</div>
					<div class="course__progress">
						<ul class="lessons-list marafone-lessons">
							<li class="<?php selectingPage($post->post_name, 'marafon_before') ?> free-item">
								<a>
									<svg width="8" height="8" viewBox="0 0 9 8" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
										<circle cx="4.71875" cy="4" r="4" fill="#D0D0E1"/>
									</svg>
									До старта. Выбираем клиента и проект
								</a>
							</li>
							<li class="<?php selectingPage($post->post_name, 'marafon_day1') ?> free-item">
								<a>
									<svg width="8" height="8" viewBox="0 0 9 8" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
										<circle cx="4.71875" cy="4" r="4" fill="#D0D0E1"/>
									</svg>
									1-й день. Прототип главного экрана
								</a>
							</li>
							<li class="<?php selectingPage($post->post_name, 'marafon_day2') ?> free-item">
								<a>
									<svg width="8" height="8" viewBox="0 0 9 8" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
										<circle cx="4.71875" cy="4" r="4" fill="#D0D0E1"/>
									</svg>
									2-й день. Дизайн главного экрана
								</a>
							</li>
							<li class="<?php selectingPage($post->post_name, 'marafon_day3') ?> free-item">
								<a>
									<svg width="8" height="8" viewBox="0 0 9 8" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
										<circle cx="4.71875" cy="4" r="4" fill="#D0D0E1"/>
									</svg>
									3-й день. Разбор готовых работ
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="course">
					...
					<div class="course__progress">
						<ul class="lessons-list paid-lessons">
							...
							<li class="<?php selectingPage($post->post_name, 'techdesign') ?>"><span class="number">6</span>
								<a>
									<svg width="8" height="8" viewBox="0 0 9 8" fill="none"
									     xmlns="http://www.w3.org/2000/svg">
										<circle cx="4.71875" cy="4" r="4" fill="#D0D0E1"/>
	...
	<div class="content">
		<div class="content__wrapper">
			...
			<p class="breadcrumbs text-grey">UX/UI марафон / <?php the_field('lesson_num') ?></p>
			<h1><?php the_field('title_name') ?></h1>

			<?php include 'assets/componets/uxmarafon.php' ?>
