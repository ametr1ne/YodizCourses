...
<head>
	...
	<link rel="stylesheet" href="<?=get_template_directory_uri()?>/assets/css/lesson1.min.css"/>
    ...
    <?php wp_head();?>
	<script type="text/javascript">!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src='https://vk.com/js/api/openapi.js?169',t.onload=function(){VK.Retargeting.Init("VK-RTRG-1400859-5BqGB"),VK.Retargeting.Hit()},document.head.appendChild(t)}();</script><noscript><img src="https://vk.com/rtrg?p=VK-RTRG-1400859-5BqGB" style="position:fixed; left:-999px;" alt=""/></noscript>
</head>
<body>
<div class="dark"></div>
