...
<div class="checking-hw content-item">
    ...
    <div class="checking-hw__avatars">
        <div class="avatars-item"><img src="<?= get_template_directory_uri() ?>/dev/assetssets/img/1.png" alt="dima"></div>
        <div class="avatars-item"><img src="<?= get_template_directory_uri() ?>/dev/assetssets/img/2.png" alt="lika"></div>
        <div class="avatars-item"><img src="<?= get_template_directory_uri() ?>/dev/assetssets/img/3.png" alt="lesha"></div>
    </div>
